...
def calculate_percentage_accuracy(average_angle_status, tolerances, input_angles, shot_stats):
    ...
    print('considered_angles_high_dict', considered_high_std_angles_dict, 'totally_wrong_high_angles_dict', totally_wrong_high_std_angles_dict)
    print('considered_angles_low_dict', considered_low_std_angles_dict, 'totally_wrong_low_angles_dict', totally_wrong_low_std_angles_dict)
    overall_correctness = sum(correctness) / considered_angles
...
#                   actual_deviation = input_angle_value - avg_value
#                   expected_deviation = abs(2*use_upper_tolerance - avg_value)
#                   error = (actual_deviation/expected_deviation)*100
#                   print('error', error)
#                   if error<100:
#                         correct_percentage = 100 - error
...
#                   actual_deviation = avg_value - input_angle_value
#                   expected_deviation = abs(avg_value - 2*use_lower_tolerance)
#                   error = (actual_deviation/expected_deviation)*100
#                   print('error', error)
#                   if error<100:
#                         correct_percentage = 100 - error
